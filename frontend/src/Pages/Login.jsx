...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/${formData.role}/login`,
        formData
      );
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[url(https://etimg.etb2bimg.com/photo/92584295.cms)] bg-cover ">
